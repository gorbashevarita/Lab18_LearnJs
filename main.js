...
let huge = BigInt("7895456212459878955613216487898554554487");
let isAlive = true;
let isWorking = false;
let isAdult = age >= 18;
let x;
...
let fruits = ["яблоко", "банан", "фпельсин"];
...
let a2 = 3;
let b2 = 4;
console.log("Сумма: ",3 + 4);
console.log("Произведение: ", 3 * 4);
...
switch (monthNumber) {
  ...
  default: console.log("Некорректное значение месяца.");
}
